...
1. Use the Enable/Disable Classification Rules toggle to turn these on or off.&#x20;
...
1. Within the relevant Classification select the Rules tab.
2. Select Create and Classification Rule from the dropdown.
3. **Classification:** Select the classification this rule will apply to from the dropdown list.
...
1. Drag and reorder the cards in your Rules list to change the priority.
