...
Customise the access of users from the user settings page in the Control Hub. You can edit a users access, add additional groups and generate API keys. User groups are created and set up as part of configuration.&#x20;
...
1. Find the user you want to edit.
   * Search for a user within the filters panel or use the filters to narrow down the list.
2. Select the API Key button for the user.
3. Select Generate API Key to create a new key.
4. Select Delete API key to remove any existing keys for this user.
