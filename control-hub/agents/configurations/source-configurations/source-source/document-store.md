...
Connect your DocumentStore source to Workplace AI to make the most of the data. You can either set up your DocumentStore using the storage root folder location or a storage plugin like Azure Storage.
