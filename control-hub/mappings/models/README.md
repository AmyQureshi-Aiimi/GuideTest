...
Models are the top level data structures that can be used. They are parents to Sub Models.

### Sub Models

A type of model that is the child of a Model. Sub Models cannot have further sub models and only connect to one Model.
