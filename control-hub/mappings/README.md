...
Rank features allow you to store sparse vectors and weights within the index. Rank features store the 'term' being indexed and the corresponding weight, which represents the importance of the term.

[Read more in out Rank Features guide.](rank-features.md)
